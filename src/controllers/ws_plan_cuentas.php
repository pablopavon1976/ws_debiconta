...
include_once ('src/funciones/igtech.funciones_plan_cuentas.php');

$app->get('/plan_cuentas/{empresa}',function(Request $request,Response $response){
    ...
    try{
        ...
        // if($w_datos_token->respuesta ==0 and $w_autorizacion['datos']['estado']=='V'){
            $o_respuesta=listaPlanCuentas($w_empresa);
